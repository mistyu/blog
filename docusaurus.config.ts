...
const beian = '赣ICP备2022011372号-1'
const beian1 = '赣ICP备2022011372号'

const config: Config = {
  title: '一月',
  url: 'https://mistyu.com',
  baseUrl: '/',
  favicon: 'img/favicon.ico',
  organizationName: 'yiyue',
  projectName: 'blog',
  customFields: {
    bio: '种一棵树最好是十年前，其次是现在',
    description:
      '是一个由一月创建的个人博客，主要分享编程开发知识和项目，该网站基于 React 驱动的静态网站生成器 Docusaurus 构建。',
  },
  themeConfig: {
    // announcementBar: {
    ...
    footer: {
      ...
      copyright: `
        ...
        <p>Copyright © 2020 - ${new Date().getFullYear()} yiyue. | Built with Docusaurus.</p>
        `,
    },
    algolia: {
      appId: 'GV6YN1ODMO',
