...
image: https://img.yiyue.me/202312270248371.png
---
...
```bash
deno run https://deno.yiyue.me/main.ts
```

在第一次使用时下载并缓存代码，你可以通过

```bash
deno info http://deno.yiyue.me/main.ts
```

来查看文件信息，如下

![](https://img.yiyue.me/deb0_lGYRA.png)
...
你可以通过 [https://yiyue.deno.dev/](https://yiyue.deno.dev/ 'https://yiyue.deno.dev/') 来访问我使用 deno Deploy 所创建的一个在线项目。将会输出一个`Hello World!` 的页面。
